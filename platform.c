 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Fri May 20 22:39:08 2022
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                platform
...
extern void platform_Outputs_wrapper(const real_T *u0,
  real_T *y0,
  const real_T *xC,
  const real_T *p0, const int_T p_width0,
  const real_T *p1, const int_T p_width1);
extern void platform_Derivatives_wrapper(const real_T *u0,
  real_T *y0,
  real_T *dx,
  real_T *xC,
  const real_T *p0, const int_T p_width0,
...
{
  const real_T *initialstate = mxGetPr(ssGetSFcnParam(S,0));
    real_T *xC = ssGetContStates(S);
    int_T  i;

   
    for (i=0;i<4;i++) xC[i]=initialstate[i]; 
}
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  platform_Outputs_wrapper(u0, y0, xC, p0, p_width0, p1, p_width1);
}
...
static void mdlDerivatives(SimStruct *S)
{
  ...
  const real_T *p0 = (const real_T *) mxGetData(PARAM_DEF0(S));
  const real_T *p1 = (const real_T *) mxGetData(PARAM_DEF1(S));
  platform_Derivatives_wrapper(u0, y0, dx, xC, p0, p_width0, p1, p_width1);
}
