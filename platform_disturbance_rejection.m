...
for i=1:N;
  ...
  u=[-F*(xInitial-xeq)-Fq*qk+ueq(1);ueq(2)]';

  % Integrator update

  qk=qk+Cy*(xInitial-xeq);

  % Current sampling time

  t=(i-1)*Ts;

  if (t >= 15) u(2) = 1;  % Constant unit amplitude disturbance force acting from t=15 secs onwards
  end;
...
grid;
title('Disturbance Rejection on Position (Disturbance acting at t=15 secs)');
